...
#CUSTOM DATABASE CREATION - ALL PART2 (REQUIRES WIKIART DATABASE DOWNLOAD)
#by JON THUM
...
#SAVE DATAFILES
json.dump(filenames, open("filenames_all_part2.json", "w"))
np.save("classes_all_part2.npy",classes)
