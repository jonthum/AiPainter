...
#CUSTOM DATABASE CREATION - MODERN CROP (REQUIRES WIKIART DATABASE DOWNLOAD)
#by JON THUM
...
STYLE = [140, 141, 142, 147, 149, 150, 165]


DATA_DIR = 'data/wikiart/'
RES = 1024
OUT_DIR = 'data/mod_style_crop/'    
idx = 0
...
#SAVE DATAFILES
json.dump(filenames, open("filenames_modern_style.json", "w"))
