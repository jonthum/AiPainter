...
#CUSTOM DATABASE CREATION - IMPRESSIONIST CROP (REQUIRES WIKIART DATABASE DOWNLOAD)
#by JON THUM
...
#SAVE DATAFILES
json.dump(filenames, open("filenames_imp_style.json", "w"))
